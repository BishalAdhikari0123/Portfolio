  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-emerald-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30">
        ...
        <div
          className="absolute bottom-20 right-20 w-80 h-80 bg-gradient-to-r from-secondary-400 to-accent-400 rounded-full blur-3xl animate-float"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full blur-3xl animate-float"
        ...
        <div className="text-center">
          ...
          >
            <motion.div
              ...
              className="w-48 h-48 mx-auto mb-8 rounded-full bg-gradient-to-br from-accent-600 via-secondary-600 to-accent-800 shadow-2xl shadow-accent-500/25 flex items-center justify-center animate-glow overflow-hidden"
            >
              <img
                src="/profile.jpg"
                alt="Bishal Adhikari"
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-gray-900 mb-4 font-display">
              ...
              <span className="block bg-gradient-to-r from-accent-600 to-secondary-600 bg-clip-text text-transparent">
                Adhikari
              </span>
            </h1>
          </motion.div>
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Passionate about designing scalable REST APIs and real-time
              applications. Strong in Node.js/TypeScript, PostgreSQL, and
              MongoDB, with solid React/Next.js frontend skills.
            </p>
          </motion.div>
          ...
          >
            <ArrowDown
              size={32}
              className="text-accent-600 hover:text-accent-800 transition-colors duration-200"
            />
          </motion.button>
        </div>
      </div>
